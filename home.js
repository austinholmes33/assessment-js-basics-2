...
const canWeDeliver = (zipcode) => {
    if(deliveryAreaZipCodes.includes(85203, 2)) {
        return "You're in our delivery zone!"
    } else if(deliveryAreaZipCodes.includes(84600, 5)) {
        return "Sorry, we can't deliver to that address"
    }
}

//console.log(canWeDeliver(deliveryAreaZipCodes[2]))
